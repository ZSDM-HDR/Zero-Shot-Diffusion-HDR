...
from .clipmodel import CLIP, CustomTextCLIP, convert_weights_to_lp, convert_to_custom_text_state_dict,\
    resize_pos_embed, get_cast_dtype
from .daclip_base import DaCLIP
...
def create_model(
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        if custom_text:
            ...
            elif "daclip" in model_name:                                #change to "my_daclip" ?
